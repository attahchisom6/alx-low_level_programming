...
skiplist_t *linear_skip(skiplist_t *list, int value)
{
	...
	stop = temp;
	/*The current node 'stop'  we are at is the desired port. Now try to check*/
	/*if value is contained within a node in this port by tranvesing linearly*/
	/*value should be contained between 'stop' and the other express nodes*/
	/*else the the port contains values not in list*/
